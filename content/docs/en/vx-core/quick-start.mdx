...
This guide explains how to run vx-core in server mode on Linux. For graphical deployment, use the [VX client server panel](/docs/vx/manual/vx-core-panel) instead.
