...
Use node chain when you need a fixed downstream hop (for example exit via a specific region) on top of whatever node the selector picks. See [Chain Proxy](/docs/vx/manual/chain-proxy) for details and limitations.
...
- [Chain Proxy](/docs/vx/manual/chain-proxy) — landing nodes and multi-hop proxy
